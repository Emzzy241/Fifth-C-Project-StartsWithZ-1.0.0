# Name Starts With Z Application
#### made by Mojiboye Emmanuel

#### Input your name and application determines if it starts with Z
...
## Description
_A C# Application to determine whether or not your name starts with a Z.... In this Application, you learn one of the easiest methods of C#; the StartsWith() method, and as the name implies, it checks to see if a string starts_
